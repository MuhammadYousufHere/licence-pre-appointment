      ...
      <div className="publicmessage_body">
        ...
        <div className="publicmessage_body_content">
          <h5>
            ...
            regarding non-issuance driving license, the Sindh Police Department
            has decided to re-open the driving license branches on a limited
            scale through online token management system.
          </h5>
          <div className="by">
